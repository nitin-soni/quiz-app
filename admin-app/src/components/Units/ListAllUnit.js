...
class ListAllUnit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    deleteItem() {
        ...
        unitService.deleteItem({guid: this.state.itemToRemove}).then(
            success => {
            ...
            <div>
                <div className="container-fluid">
                    ...
                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 className="h3 mb-0 text-gray-800">Manage Units</h1>
