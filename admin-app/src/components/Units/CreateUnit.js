...
class CreateUnit extends React.Component{
    ...
    saveItem = event => {
        ...
        if (this.validator.allValid()) {
            ...
            unitService.createItem(item).then(
                success => {
        ...
        return(
            <Modal isOpen={this.props.showCreateItemModal} toggle={this.props.toggleCreateItemModal}
                ...
                <form className="user" id='saveItemForm'>
                    <ModalHeader toggle={this.props.toggleCreateItemModal}>Create Unit</ModalHeader>
                    <ModalBody>
                        <div className="form-group">
                            <input type="text" className="form-control "
                                   id="name" name="name"
                                   placeholder="Unit Name" value={this.state.item.name}
