...
class ListAllUnitTopic extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            itemToEdit: {},
            itemsList: [],
            tableSorting: [{columnName: 'question', direction: 'asc'}],
            tableFilter: [],
            totalItemCount: 0,
            totalPageCount: -1,
            pageSize: 5,
    ...
    deleteItem() {
        this.setState({isLoading: true});
        questionService.deleteItem({guid: this.state.itemToRemove}).then(
            success => {
            ...
            <div>
                <div className="container-fluid">
                    ...
                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 className="h3 mb-0 text-gray-800">Manage Questions</h1>
